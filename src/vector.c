...
#define DEFINE_VECTOR(BIT, CAST)                                                                                             \
    ...
    {                                                                                                                        \
        vector##BIT##_t v = init_vector##BIT(size);                                                                          \
    ...
    {                                                                                                                        \
        ...
        return 1;                                                                                                            \
                                                                                                                             ...
                                                                                                                             \
    __attribute__((optimize("no-tree-vectorize"))) vector##BIT##_t naive_scale##BIT(param##BIT##_t param, vector##BIT##_t v) \
    {                                                                                                                        \
        vector##BIT##_t res = init_vector##BIT(v.size);                                                                      \

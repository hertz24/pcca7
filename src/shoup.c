...
Vector unrolling_shoup_scale_avx2(Parameters param, Vector v)
{
    ...
    for (; i + 31 < size; i += 32)
    {
        __m256i va_input_0 = _mm256_loadu_si256((__m256i const *)(v.elements + i));
        __m256i va_input_1 = _mm256_loadu_si256((__m256i const *)(v.elements + i + 8));
        __m256i va_input_2 = _mm256_loadu_si256((__m256i const *)(v.elements + i + 16));
        __m256i va_input_3 = _mm256_loadu_si256((__m256i const *)(v.elements + i + 24));

        __m256i va_odd_0 = _mm256_srli_epi64(va_input_0, 32);
        ...
        __m256i c_even_0 = _shoup_avx2(va_input_0, vb, vb_precomp, vp, mask_32);
        ...
        __m256i c_odd_0 = _shoup_avx2(va_odd_0, vb, vb_precomp, vp, mask_32);
...
Vector shoup_scale_mullo_avx2(Parameters param, Vector v)
{
    ...
    for (; i + 31 < size; i += 32)
    {
        ...
        __m256i c_even_0 = _shoup_mullo_avx2(va_input_0, vb, vb_precomp, vp);
        ...
        __m256i c_odd_0 = _shoup_mullo_avx2(va_odd_0, vb, vb_precomp, vp);
...
Vector shoup_b1_scale_avx2(Parameters param, Vector v)
{
    ...
    for (; i + 31 < size; i += 32)
    {
        ...
        __m256i c_even_0 = _shoup_b1_avx2(va_input_0, vb_precomp, vp, mask_32);
        ...
        __m256i c_odd_0 = _shoup_b1_avx2(va_odd_0, vb_precomp, vp, mask_32);

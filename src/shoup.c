...
Vector shoup_scale_avx2(Parameters param, Vector v)
{
    ...
    for (; i + 7 < size; i += 8)
    {
        ...
        __m256i va_input = _mm256_loadu_si256((__m256i const *)(v.elements + i));

        // 3. Split 8 elements into two sets of 4 : va_input and va_odd
        __m256i va_odd = _mm256_srli_epi64(va_input, 32); // Elements [null, 7, null, 5, null , 3, null, 1]

        // 4. Process Even Lanes:
        __m256i c_even = _shoup_avx2(va_input, vb, vb_precomp, vp, mask_32);

        // 5. Process Odd Lanes:
        __m256i c_odd = _shoup_avx2(va_odd, vb, vb_precomp, vp, mask_32);

        // 6. Shift odd by 32 bits to the left results back and merge:
        __m256i res1_odd_shifted = _mm256_slli_epi64(c_odd, 32);           // [7, null, 5, null, 3, null, 1, null]
        __m256i res1_combined = _mm256_or_si256(c_even, res1_odd_shifted); // [7, null, 5, null, 3, null, 1, null] or [null, 6, null, 4, null, 2, null, 0]
...
static inline __m256i _shoup_b1_avx2(__m256i va, __m256i vb_precomp, __m256i vp, __m256i mask32)
{
    __m256i q = _mm256_mul_epu32(va, vb_precomp);
    q = _mm256_srli_epi64(q, 32);
    __m256i qp = _mm256_mul_epu32(q, vp);
...
Vector shoup_b1_scale_avx2(Parameters param, Vector v)
{
    ...
    for (; i + 31 < size; i += 32)
    {
        ...
        __m256i c_even_1 = _shoup_b1_avx2(va_input_1, vb_precomp, vp, mask_32);
        __m256i c_even_2 = _shoup_b1_avx2(va_input_2, vb_precomp, vp, mask_32);
        __m256i c_even_3 = _shoup_b1_avx2(va_input_3, vb_precomp, vp, mask_32);
        __m256i c_even_4 = _shoup_b1_avx2(va_input_4, vb_precomp, vp, mask_32);

        __m256i c_odd_1 = _shoup_b1_avx2(va_odd_1, vb_precomp, vp, mask_32);
        ...
        __m256i c_odd_4 = _shoup_b1_avx2(va_odd_4, vb_precomp, vp, mask_32);
...
Vector shoup_scale_avx512(Parameters param, Vector v)
{
    ...
    for (; i + 15 < size; i += 16)
    {
        ...
        __m512i shift = _mm512_slli_epi64(odd_vc, 32);

        __m512i merge = _mm512_or_si512(even_vc, shift);
...
Vector unrolling_shoup_scale_avx512(Parameters param, Vector v)
{
    ...
    for (; i + 63 < size; i += 64)
    {
        __m512i even_va_1 = _mm512_loadu_si512((__m512i const *)(v.elements + i));
        __m512i even_va_2 = _mm512_loadu_si512((__m512i const *)(v.elements + i + 16));
        __m512i even_va_3 = _mm512_loadu_si512((__m512i const *)(v.elements + i + 32));
        __m512i even_va_4 = _mm512_loadu_si512((__m512i const *)(v.elements + i + 48));
        ...
        __m512i odd_va_4 = _mm512_srli_epi64(even_va_4, 32);
        ...
        __m512i even_vc_4 = _shoup_avx512(even_va_4, vb, vb_precomp, vp);
        ...
        __m512i odd_vc_4 = _shoup_avx512(odd_va_4, vb, vb_precomp, vp);

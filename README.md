...
The Makefile automatically detects the host architecture and enables appropriate SIMD instructions for optimal performance on x86_64 (AVX2/AVX-512) or ARM-based systems (NEON).
